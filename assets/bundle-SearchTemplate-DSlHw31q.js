...
import 'piccolore';
import { g as getPageData, p as products, $ as $$Layout, c as categories, a as $$Header, b as $$Footer, s as siteData, D as DEFAULT_LANGUAGE } from './bundle-Footer-CHnRoRiL.js';
import { $ as $$AddToCartBtn } from './bundle-AddToCartBtn-BmHmCfe-.js';
...
const $$SearchTemplate = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const baseUrl = "/ob-simatic".replace(/\/$/, "");
