...
import 'piccolore';
import 'clsx';
import { s as siteData, d as getLocalizedPath, c as categories, p as products } from './bundle-Footer-CHnRoRiL.js';
import fs from 'node:fs';
import path from 'node:path';
/* empty css                               */
import { g as getCategoryImage } from './bundle-categoryImages-ByIgFT0o.js';
import { $ as $$ProductCard } from './bundle-ProductCard-u1XCPIKB.js';
import fs$1 from 'fs';
...
const $$HeroSearch = createComponent(($$result, $$props, $$slots) => {
  ...
  let heroImage = "";
  const BASE_URL = "/ob-simatic".replace(/\/$/, "");
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/HeroSearch.astro", void 0);
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/ServicePillars.astro", void 0);
...
const $$ProductCategories = createComponent(($$result, $$props, $$slots) => {
  ...
  const categories$1 = allCategories.filter((cat) => cat.parentSlug === null).map((cat) => ({
    title: cat.name,
    slug: cat.slug,
    image: cat.image
  }));
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/ProductCategories.astro", void 0);
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/FeaturedProducts.astro", void 0);
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/Manufacturers.astro", void 0);
...
const $$Popup = createComponent(($$result, $$props, $$slots) => {
  ...
  try {
    ...
    if (fs.existsSync(popupDir)) {
      ...
      if (foundImage) {
        image = `${"/ob-simatic".replace(/\/$/, "")}/images/floatingpopup/${foundImage}`;
      }
    }
  } catch (e) {
