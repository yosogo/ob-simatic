import { c as createAstro, a as createComponent, r as renderComponent, d as renderTemplate, m as maybeRenderHead, e as addAttribute, u as unescapeHTML, F as Fragment, b as renderScript, f as defineStyleVars, g as renderHead, h as renderSlot } from './bundle-astro/server-iX5mIn4f.js';
import 'piccolore';
/* empty css                                */
import 'clsx';
import { i as isRTL, c as categories, S as SUPPORTED_LANGUAGES, a as getLocalizedPath } from './bundle-i18n-C_ibLEKJ.js';

const name = "";
const shortName = "OB Simatic";
const metaDescription = "PLC, Sürücü, Panel ve Endüstriyel Otomasyon Ürünleri Tedarikçisi";
const contact$1 = {"phone":"+90 539 612 75 64","whatsapp":"+905396127564","email":"info@obsimatic.com","address":"ob-simatic , Kilis , Türkiye","i18n":{"ar":{"phone":"","whatsapp":"","email":"","address":""},"en":{"phone":"","whatsapp":"","email":"","address":""},"tr":{"phone":"","whatsapp":"","email":"","address":""}}};
const colors = {"primaryRgb":"219, 158, 46"};
...
const messages$1 = {"floating_button":{"ar":"مرحباً، لدي استفسار.","en":"Hello, I have a question.","tr":"Merhaba, bir sorum var."},"floating_button_custom":{"enabled":false,"code":""}};
const copyright = "Ekkeri. Tüm hakları saklıdır.";
const campaign_popup = {"enabled":false,"cta_link":""};
const siteData = {
  name,
  shortName,
  metaDescription,
...
const $$Astro$6 = createAstro("https://yosogo.github.io");
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/FloatingButtons.astro", void 0);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "C:/Users/muhammed/Desktop/code/anode/project/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/muhammed/Desktop/code/anode/project/node_modules/astro/components/ClientRouter.astro", void 0);
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(lang, "lang")}${addAttribute(direction, "dir")}${addAttribute($$definedVars, "style")}> <head><meta charset="UTF-8"><meta name="description"${addAttribute(siteData.metaDescription, "content")}><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml"${addAttribute(`${"/ob-simatic"}/favicon.svg`, "href")}><meta name="generator"${addAttribute(Astro2.generator, "content")}><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet"><link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet"><title>${title}</title>${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body${addAttribute($$definedVars, "style")}> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "FloatingButtons", $$FloatingButtons, {})} </body></html>`;
}, "C:/Users/muhammed/Desktop/code/anode/project/src/layouts/Layout.astro", void 0);
...
const $$MegaMenu = createComponent(($$result, $$props, $$slots) => {
  ...
  function getChildren(parentSlug) {
    return categoriesList.filter((cat) => cat.parentSlug === parentSlug);
  }
  function buildCategoryHTML(parentSlug, level) {
    ...
    for (const cat of cats) {
      ...
      html += `<a href="${baseUrl}/${cat.slug}" title="${cat.name}"><span>${cat.name}</span></a>`;
      if (hasChildren) {
...
}, "C:/Users/muhammed/Desktop/code/anode/project/src/components/MegaMenu.astro", void 0);

const contact = {"phone":"+90 539 612 75 64","whatsapp":"905396127564","email":"info@obsimatic.com","address":"ob-simatic , Kilis , Türkiye","i18n":{"ar":{"phone":"","whatsapp":"","email":"","address":""},"en":{"phone":"","whatsapp":"","email":"","address":""},"tr":{"phone":"","whatsapp":"","email":"","address":""}}};
const social = {"facebook":"#ekkeri","instagram":"#ekkeri","linkedin":"","twitter":"#ekkeri","youtube":"#ekkeri"};
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  const getContactInfo = (key) => {
    ...
    const val = localized[key] || contact[key] || siteData.contact?.[key];
    return val;
  };
