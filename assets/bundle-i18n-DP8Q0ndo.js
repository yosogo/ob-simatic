...
async function getUI(lang) {
  try {
    const ui = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"../data/ar/ui.json": () => import('./bundle-ui-DfcQMrnj.js'),"../data/en/ui.json": () => import('./bundle-ui-CrUjWxcw.js'),"../data/tr/ui.json": () => import('./bundle-ui-DqwIqw2e.js')})), `../data/${lang}/ui.json`, 4);
    return ui.default;
  } catch {
    const ui = await import('./bundle-ui-DqwIqw2e.js');
    return ui.default;
  }
}
async function getSite(lang) {
  try {
    const site = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"../data/ar/site.json": () => import('./bundle-site-_JXwwSti.js'),"../data/en/site.json": () => import('./bundle-site-BRxuoI6_.js'),"../data/tr/site.json": () => import('./bundle-site-B7_5ED0X.js')})), `../data/${lang}/site.json`, 4);
    return site.default;
  } catch {
    const site = await import('./bundle-site-B7_5ED0X.js');
    return site.default;
  }
}
